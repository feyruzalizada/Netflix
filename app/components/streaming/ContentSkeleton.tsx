export function ContentCardSkeleton() {
  return (
    <div className="flex-shrink-0 w-64 sm:w-80 rounded overflow-hidden animate-pulse">
...
export function FeaturedSkeleton() {
  return (
    <div className="relative h-96 mb-12 rounded-lg overflow-hidden animate-pulse bg-gray-800">
...
export function GeoStatusSkeleton() {
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 mb-8 animate-pulse">
